...
function draw() {
    ...
    // Jogador (desenha a imagem do jogador)
    ctx.drawImage(playerImage, player.x, player.y, player.width, player.height);

    // Celulares (desenha a imagem do celular)
    ...
    ctx.fillText("Pegos: " + score + "/15", 380, 25);
}
...
// Inicia o jogo depois que as imagens são carregadas
Promise.all([
